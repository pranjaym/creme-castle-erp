...
export const REPORTS: Record<string, ReportDef> = {
  ...
  petpooja_store_status: {
    key: 'petpooja_store_status',
    group: 'Petpooja',
    desc: 'Petpooja Online Store Logs: every status poll and every manual or platform on/off event, per app, with the raw request and response.',
    label: 'Store on/off log (Petpooja)',
    view: 'v_rpt_petpooja_store_status',
    columns: ['business_date', 'store', 'petpooja_rest_id', 'client_hash', 'logged_at', 'app', 'event_kind',
      'request_type', 'current_status', 'http_status', 'user_details', 'request_json', 'response_json'],
    headers: ['Business Date', 'Store', 'Petpooja Outlet ID', 'Client Hash', 'Logged At', 'App', 'Event Kind',
      'Request Type', 'Status', 'HTTP Status', 'User Details', 'Request JSON', 'Response JSON'],
    filenameStem: 'cc_petpooja_store_status',
    orderBy: ['business_date', 'store', 'logged_at'],
  },
  petpooja_item_toggle: {
    key: 'petpooja_item_toggle',
    group: 'Petpooja',
    desc: 'Petpooja Online Item On/Off Logs: each item switched off or on, per app, manual (a person) or automatic (stock rule), with the stock item that ran out.',
    label: 'Item on/off log (Petpooja)',
    view: 'v_rpt_petpooja_item_toggle',
    columns: ['business_date', 'store', 'petpooja_rest_id', 'app', 'logged_at', 'action', 'object_type', 'trigger',
      'actor_name', 'actor', 'window_from', 'window_to', 'item_ids', 'item_names', 'reason', 'stock_item',
      'stock_realtime', 'stock_par', 'http_status'],
    headers: ['Business Date', 'Store', 'Petpooja Outlet ID', 'App', 'Logged At', 'Action', 'Object', 'Trigger',
      'Actor', 'Actor Details', 'Window From', 'Window To', 'Item IDs', 'Item Names', 'Reason', 'Stock Item',
      'Real-Time Stock', 'Par Stock', 'HTTP Status'],
    filenameStem: 'cc_petpooja_item_toggle',
    orderBy: ['business_date', 'store', 'logged_at'],
  },
  petpooja_order_activity: {
    key: 'petpooja_order_activity',
    group: 'Petpooja',
    desc: 'Petpooja Online Order Activity Report: the journey of every order on both apps, received to delivered, cancelled or returned.',
    label: 'Order activity (Petpooja, both apps)',
    view: 'v_rpt_petpooja_order_activity',
    columns: ['business_date', 'store', 'petpooja_rest_id', 'client_hash', 'order_id', 'app_guess', 'order_status',
      'received_at', 'accepted_at', 'mark_ready_at', 'rider_arrival_at', 'picked_up_at', 'delivered_at',
      'cancelled_at', 'returned_at', 'accept_to_ready_min', 'rider_wait_min', 'received_to_delivered_min'],
    headers: ['Business Date', 'Store', 'Petpooja Outlet ID', 'Client Hash', 'Order ID', 'App', 'Order Status',
      'Received', 'Accepted', 'Mark Ready', 'Rider Arrival', 'Picked Up', 'Delivered', 'Cancelled',
      'Returned To Store', 'Accept to Ready (min)', 'Rider Wait (min)', 'Received to Delivered (min)'],
    filenameStem: 'cc_petpooja_order_activity',
    orderBy: ['business_date', 'store', 'received_at'],
  },
  outlets: {
    key: 'outlets',
    label: 'Outlet master',
