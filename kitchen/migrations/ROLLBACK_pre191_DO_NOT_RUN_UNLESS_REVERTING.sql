-- ROLLBACK POINT captured before migration 191 was applied, 26 Aug 2026.
-- These are the EXACT live definitions of the three functions as they stood
-- with the old (wrong) store-caused rejection vocabulary. Run this file to
